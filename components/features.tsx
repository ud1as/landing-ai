      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            <h2 className="h2 mb-4">The majority our customers challenges in managing vast amounts of data</h2>
            <p className="text-xl text-gray-400">These challenges lead to delays, errors, and increased operational cost</p>
          </div>
          ...
          <div className="max-w-sm mx-auto grid gap-8 md:grid-cols-2 lg:grid-cols-3 lg:gap-16 items-start md:max-w-2xl lg:max-w-none" data-aos-id-blocks>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Enhanced Efficiency</h4>
              <p className="text-lg text-gray-400 text-center">Our application reduces the time and effort required for manual searches. It minimizes data entry errors and ensures that employees have access to accurate information.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="200" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">Automation Routine</h4>
              <p className="text-lg text-gray-400 text-center">Our application automates routine tasks such as order processing, inventory management, and customer service inquiries, freeing up valuable time for employees to focus on strategic activities.</p>
            </div>
            ...
            <div className="relative flex flex-col items-center" data-aos="fade-up" data-aos-delay="500" data-aos-anchor="[data-aos-id-blocks]">
              ...
              <h4 className="h4 mb-2">24/7 Customer Service</h4>
              <p className="text-lg text-gray-400 text-center">Our AI-powered chatbots and virtual assistants handle customer inquiries and provide personalized support 24/7, enhancing customer satisfaction and loyalty while reducing the burden on human agents.</p>
            </div>
